        ...
        <section class="practic-list">
            ...
            <div class="practic-list__wrap">
                <div class="container">
                    ...
                    <div class="to-back"><span class="to-back__first-arrow"></span><span class="to-back__second-arrow"></span><a href="./practic.html">Вернуться назад</a></div>
                    <div class="practic-list__content">
                        <div class="practic-list__wrap-background">
                            <span>
                                В этом упражнении Вы услышите два одинаковых фрагмента с разным балансом громкости.
                                Ваша цель - определить в каком фрагменте баланс громкости выстроен корректно.
                                Также Вы можете услышать один фрагмент и предположить, 
                                какие на Ваш слух коррекции необходимо произвести с балансом громкости.
                            </span>
                            <a href="./assets/balance/balance-task-1.html" class="button-link button-link_task"><button class="button-gold button-gold_task">Начать</button></a>
                        </div>
                    </div>
