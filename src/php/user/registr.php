...
<html lang="en">
    <head>
        ...
        <title>bitmaker course - registr</title>
        ...
        <div class="page-content">
            ...
            <div class="page-content__wrap">
                ...
                <div class="registration-form__wrap">
                    <h2 class="page-content__title">Регистрация</h2>
                    <form action="./vendor/signup.php" method="POST" class="registration-form">
                        ...
                        <button type="submit" class="button-gold"><a href="#" class="button-link">Регистрация</a></button>
                    </form>
                    <div class="registration-form__wrap_title">
                        <span class="registration-form__description">Уже есть аккаунт?</span>
                        <a href="./login.html" class="registration-form__link">Войти</a>
                    </div>
                </div>
            </div>
        </div>
