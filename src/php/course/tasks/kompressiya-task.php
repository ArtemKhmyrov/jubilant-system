                ...
                <div class="container">
                    ...
                    <div class="practic-list__content">
                        <div class="practic-list__wrap-background">
                            <span>
                                В этом упражнении Вы услышите два одинаковых фрагмента с применением разной компрессии сигнала. Ваша цель - определить в каком фрагменте компрессия настроена корректно.
                                Также Вы можете услышать один фрагмент и предположить, какие на Ваш слух настройки компрессии необходимо произвести.
                            </span>
                            <button class="button-gold button-gold_task"><a href="#" class="button-link button-link_task">Начать</a></button>
                        </div>
                    </div>
