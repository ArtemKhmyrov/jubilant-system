                ...
                <div class="container">
                    ...
                    <div class="practic-list__content">
                        <div class="practic-list__wrap-background">
                            <span>
                                В этом упражнении Вы услышите фрагмент дорожки с применением некоторого эффекта обработки сигнала (delay, сатурация, дисторшн и т.д.). Ваша цель - определить в чем была допущена ошибка.
                            </span>
