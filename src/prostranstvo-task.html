                ...
                <div class="container">
                    ...
                    <div class="practic-list__content">
                        <div class="practic-list__wrap-background">
                            <span>
                                В этом упражнении Вы услышите два одинаковых фрагмента с различным построением пространства. Ваша цель - определить в каком фрагменте пространство выстроено корректно.
                            </span>
