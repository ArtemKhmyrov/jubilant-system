                ...
                <div class="container">
                    ...
                    <div class="practic-list__content">
                        <div class="practic-list__wrap-background">
                            <span>
                                В этом упражнении вы услышите аккорд. Ваша цель - определить тип аккорда, который вы услышали.
                            </span>
                            <a href="../assets/accordy/accordy-task-1.html" class="button-link button-link_task"><button class="button-gold button-gold_task">Начать</button></a>
                        </div>
                    </div>
