                    ...
                    <ul class="header__list">
                        ...
                        <li class="header__item">
                            <ul class="header__item_wrap">
                                <li class="header__item">
                                    <a href="../../profile.html" class="header__item_link">Пользователь</a>
                                </li>
                                <li class="header__item">
                                    <span></span>
                                </li>
                                <li class="header__item">
                                    <a href="../../login.html" class="header__item_link">exit</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        <section class="practic-list">
            ...
            <div class="practic-list__wrap">
                <div class="container">
                    ...
                    <div class="ekvalayser__wrap">
                        <div class="ekvalayser__column">
                            <span></span>
                            <span></span>
                            <span></span>
                        </div>
                    ...
                    <div class="ekvalayser__wrap ekvalayser__wrap_reverse">
                        <div class="ekvalayser__column">
                            <span></span>
                            <span></span>
                            <span></span>
                    ...
                    <div class="ekvalayser__wrap-play">
                        <audio src=""></audio>
                        <audio controls>
                            <source src="../../assets/multimedia/SOUNDS/accord/CHORDS - MAJ1.wav">
                            Тег audio не поддерживается вашим браузером. <a href="audio/music.mp3">Скачайте музыку</a>
                          </audio>

                          <div class="ekvalayser__wrap-button">
                            <button class="ekvalayser__button" value="1">Мажор 1</button>
                            <button class="ekvalayser__button" value="0">Минор 2</button>
                            <button class="ekvalayser__button" value="0">МиМинор 1</button>
                        </div>
                    </div>
