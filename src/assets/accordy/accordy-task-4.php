            ...
            <div class="practic-list__wrap">
                <div class="container">
                    ...
                    <div class="ekvalayser__wrap-play">
                        <audio src=""></audio>
                        <audio controls>
                            <source src="../../assets/multimedia/SOUNDS/accord/CHORDS - MIN 1.wav">
                          ...
                          <div class="ekvalayser__wrap-button">
                            ...
                            <button class="ekvalayser__button" value="1">Минор 1</button>
                            <button class="ekvalayser__button" value="0">Мажор 3</button>
                        </div>
                    </div>
