...
<body>
    ...
    <main class="main">
       ...
       <section class="type-course">

            <div class="balance">
                <div class="balance-photo">
                    <picture>
                        <img src="./img/lector/balance.png" alt="">
                    </picture>
                </div>
            </div>

            <a href="./balance-info.html" class="balance-color">
                <span>Баланс</span>
            </a>

            <div class="ekvalase">
                <div class="ekvalase-photo">
                    <picture>
                        <img src="./img/lector/ekvalase.png" alt="">
                    </picture>
                </div>
            </div>

            <a href="./ekvalizatsiya-info.html" class="ekvalase-color">
                <span>Эквализация</span>
            </a>

            <div class="compress">
                <div class="compress-photo">
                    <picture>
                        <img src="./img/lector/compress.png" alt="">
                    </picture>
                </div>
            </div>

            <a href="./kompressiya-info.html" class="compress-color">
                <span>Компрессия</span>
            </a>

            <div class="effect">
                <div class="effect-photo">
                    <picture>
                        <img src="./img/lector/effect.png" alt="">
                    </picture>
                </div>
            </div>

            <a href="./panorama-info.html" class="effect-color">
                <span>Панорама</span>
            </a>


            <div class="prostranstvo">
                <div class="prostranstvo-photo">
                    <picture>
                        <img src="./img/lector/prostranstvo.png" alt="">
                    </picture>
                </div>
            </div>

            <a href="./prostranstvo-info.html" class="prostranstvo-color">
